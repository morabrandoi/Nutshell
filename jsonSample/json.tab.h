...
union YYSTYPE
{
  keyval_t key_value;                      /* key_value  */
  object_t object;                         /* object  */
  std::string* STRING_LITERAL;             /* STRING_LITERAL  */
  std::string* NUMBER_LITERAL;             /* NUMBER_LITERAL  */
  std::string* BOOLEAN_LITERAL;            /* BOOLEAN_LITERAL  */
  std::string* NULL_LITERAL;               /* NULL_LITERAL  */
  std::vector<keyval_t>* key_value_list;   /* key_value_list  */
